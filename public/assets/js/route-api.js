const __routeApi = {
    ...
    /* Post path Api */
    post: {
        listPostByBlock: '/post/list/:block_id',
        create: '/post/create/:block_id',
    ...
    bill: {
        ...
        sendToCustomer: '/room/bill/send-to-customer/:id',
    ...
    contract:{
        ...
        update:'/room/:room_id/contract/update/:contract_id',
