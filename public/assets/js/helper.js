const __helper = {
    ...
    getNumericFromString: function (value) {
        if (!__helper.checkType.isNumber(value) && !__helper.checkType.isString(value))
            return '';
    ...
    convertStringToNumber: function (value, type = 'int') {
        if (!value || __helper.checkType.isUndefined(value) || __helper.checkType.isNull(value))
            return 0;
    ...
    removeSpecials: function (str) {
        if (!__helper.checkType.isString(str))
            return str;
...
Object.defineProperty(__helper, 'checkType', {
    value: {
        ...
        isEmpty: function (value) {
            ...
            if (!__helper.checkType.isArray(value) && !__helper.checkType.isObject(value))
                return true;
        ...
        isNumber: function (value) {
            if (typeof value === 'number')
                ...
                return true;
            } else if (__helper.checkType.isString(value) && value.match(/^\d+\.\d+$/)) {
                return true;
            }
            return false;
        },
...
Object.defineProperty(__helper, 'object', {
    value: {
        ...
        mergeObject: function (dataTarget, dataSource) {
            if (!__helper.checkType.isObject(dataTarget) && __helper.checkType.isObject(dataSource))
                return {...dataSource};
            else if (__helper.checkType.isObject(dataTarget) && !__helper.checkType.isObject(dataSource))
                return {...dataTarget};
            else
...
Object.defineProperty(__helper, 'array', {
    value: {
        ...
        addOrRemoveItemInArray: function (array, value) {
            if (__helper.checkType.isEmpty(array))
                return [value];
        ...
        setSelectedToFirst: function (value, key, arrayData) {
            if (__helper.checkType.isUndefined(value) || __helper.checkType.isUndefined(key) || __helper.checkType.isUndefined(arrayData))
                return arrayData;

            const keyFind = __helper.array.findObjectInArray(value, key, arrayData, true);
